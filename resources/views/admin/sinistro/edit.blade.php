                ...
                <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <input class="form-control" name="valor_sinistro" placeholder="Valor Sinistro" type="text" value="{{$sinistros->valor_sinistro}}">               
                                </div>
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <input class="form-control" name="franquia" placeholder=" % Franquia" type="text" value="{{$sinistros->franquia}}">    
                                </div>

                                <div class="col-xs-2">
                                    <label for="NomeSegurado"><i class="fa fa-money"></i> Valor Franquia </label>
                                    <input class="form-control" name="valor_franquia" placeholder="Valor Franquia " type="text" value="{{$sinistros->valor_franquia}}">               
                                </div>
