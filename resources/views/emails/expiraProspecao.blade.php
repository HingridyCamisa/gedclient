                                ...
                                <thead>
                                  ...
                                  @foreach($data as $i => $prospecao)
                                    <tr>
                                      ...
                                      <td><center>Expira em {{\Carbon\Carbon::parse($prospecao->data_inicio)->addDays(\Carbon\Carbon::parse($prospecao->data_prevista_fim)->diffInDays($prospecao->data_inicio)+1)->diffForHumans()}} </center></td>
                                      @endforeach
                                       @endif
